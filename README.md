...
Описание задачи содержится в Linear-sliding-modes.docx. Не стал переводить его в LaTeX формат. Помимо самого MATLAB SIMULINK необходимо будет обзавестись библиотеками YALMIP и SeDuMi
